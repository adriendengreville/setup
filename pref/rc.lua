...
globalkeys = awful.util.table.join(
	...
	--awful.key({ }, "XF86AudioMute",       function() awful.util.spawn("amixer set Mast    er toggle") end),
	--awful.key({ }, "XF86AudioLowerVolume unmute",     function() awful.util.spawn("ami    xer set Master 5%-") end),
    
	--	Screenshot
	awful.key({ "Control", "Shift"}, "'", function() os.execute("puush -c -a&") end),
